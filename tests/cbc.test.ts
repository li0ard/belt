...
describe("CBC", () => {
    test("#1", () => {
        ...
        let ct = Buffer.from("10116EFAE6AD58EE14852E11DA1B8A745CF2480E8D03F1C19492E53ED3A70F60657C1EE8C0E0AE5B58388BF8A68E3309", "hex");
    ...
    test("#2", () => {
        ...
        let pt = Buffer.from("730894D6158E17CC1600185A8F411CAB0471FF85C83792398D8924EBD57D03DB95B97A9B7907E4B020960455E46176F8", "hex");
