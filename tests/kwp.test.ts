...
describe("KWP", () => {
    test("#1", () => {
        ...
        const iv = hexToBytes("5BE3D61217B96181FE6786AD716B890B");
        const pt = hexToBytes("B194BAC80A08F53B366D008E584A5DE48504FA9D1BB6C7AC252E72C202FDCE0D");
    ...
    test("#2", () => {
        ...
        const iv = hexToBytes("B5EF68D8E4A39E567153DE13D72254EE");
        const pt = hexToBytes("92632EE0C21AD9E09A39343E5C07DAA4889B03F2E6847EB152EC99F7A4D9F154");
